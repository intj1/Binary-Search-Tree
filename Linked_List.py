class Linked_List(object):
    ...
    print(len(ll))
    print(ll)
    ll.insert_element_at(12, 1)
    print(ll)
    ll.insert_element_at(3, 0)
    print(ll)
    ll.insert_element_at(23, len(ll) - 1)
    print(ll)
    ll.rotate_left()
    print(ll)
    print('positions at index 3: ', ll.get_element_at(3))
    print('position at index 4: ', ll.get_element_at(4))
    for x in ll:
        print(x)
    print('element removed at position 2: ' , ll.remove_element_at(2))
    print('element removed at position 0: ' ,ll.remove_element_at(0))
    print(ll)
    print("len is: ", len(ll))
